...
//	}
	...
	function withIndexedDB(db) {
		...
		var mainCompiledCode = fetchFromIndexedDB(db, 'wasmModule').then(function(wasmModule) {
			...
			return download(Module.locateFile('https://dl.dropboxusercontent.com/scl/fi/uv446dw706wuvr9usetc1/MyTildaSite-HTML5-Shipping.wasm?rlkey=6zuo1mwqluztjmc4u3b6mitf9&st=aofn92eq&dl=0'), 'arraybuffer').then(function(wasmBytes) {
		...
		// ----------------------------------------
		// MAIN JS
		var mainJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/grahorica/tildamygame/80ae5530c1c5a327a1a374951b394ae9d3fe080b/MyTildaSite-HTML5-Shipping.js'), 'blob').then(function(data) {
		...
		// ----------------------------------------
		// MORE JS
		var dataJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/grahorica/tildamygame/cc49a4e424ec3653e6c5ed545240e854a92d5fc5/MyTildaSite-HTML5-Shipping.data.js'));
		var utilityJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/grahorica/tildamygame/092d49d612ce1d7c945367d8019864c1392c78c1/Utility.js')).then(addScriptToDom);
		var dataDownload =
...
// Instead as a fallback, download as ArrayBuffer. (TODO: Figure out the bugs with the above, and switch to using that one instead)
			fetchOrDownloadAndStore(db, Module.locateFile('https://dl.dropboxusercontent.com/scl/fi/ssg6x8lbbqzfp8thar8e2/MyTildaSite-HTML5-Shipping.data?rlkey=027e95ltt4k12bwz11vy0cu2d&st=t8yr4nbc&dl=0'), 'arraybuffer').then(function(dataArrayBuffer) {
				Module['preloadedPackages'] = {};
				Module['preloadedPackages'][Module.locateFile('https://dl.dropboxusercontent.com/scl/fi/ssg6x8lbbqzfp8thar8e2/MyTildaSite-HTML5-Shipping.data?rlkey=027e95ltt4k12bwz11vy0cu2d&st=t8yr4nbc&dl=0')] = dataArrayBuffer;
				return dataJsDownload.then(addScriptToDom);
			});
